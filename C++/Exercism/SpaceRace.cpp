...
namespace space_age {
    ...
    space_age::space_age(int long seconds) { privateSeconds = seconds; }
    int long space_age::seconds()    const { return privateSeconds; }
    double space_age::on_earth()     const { return double(privateSeconds) / 31557600; }
